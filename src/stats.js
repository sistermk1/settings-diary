...
const PRAISE = {
  none: '最初の一歩があなたの原石になります。今日の記録から始めましょう。',
  Stone: '原石を手にしました。磨くほどに輝くのは、あなたも同じです。',
  Amber: '3日継続。地道な努力が琥珀のように結晶化し始めています。',
  Cobalt: '1週間継続。深い青は静かな集中の色。習慣付いてきましたね。',
  Ruby: '2週間継続。努力が形になってきました。時にはアナリティクスを確認してみましょう。',
  Sapphire: '30日到達。あなたには努力の才能があります。このデータにはサファイアよりも価値があります。',
  Emerald: '60日。成長の緑。時に振り返れば、最適解への道筋が見えてくるはずです。',
  Amethyst: '100日。気品の紫。ここまで続けられる人は本当にごくわずかです。自己分析を継続しましょう。',
  Diamond: '180日。半年分の記録は、ダイヤモンドよりも硬い自信になるはずです。',
  Alexandrite: '365日。光で色を変える奇跡の石。あなたの探求はもはや伝説です。様々な色からあなたは何を見つけましたか？',
};
